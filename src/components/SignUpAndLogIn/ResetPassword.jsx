import { ENTRY } from "../../Router/Routes";
...
const ResetPassword = () => {
  ...
  useEffect(() => {
    document.title = "Reset Password - Dropbox";
  }, []);
      ...
      <main className="main">
        ...
        <div className="register d-flex justify-content-center align-items-center position-absolute">
          <div className="container p-5">
            ...
            <p className="text-center text-muted fs-6">Back to <Link to={ENTRY} role="button" className="text-success text-decoration-underline">Log In</Link></p>
          </div>
        </div>
      </main>
    </>
